...
Franckys_REPL.demo = {
    reqlist:    [
        ...
        '#(say "EXEMPLE 3")',
        '#(say)',
        'P(=(* L "A(MODEL= Coconut Asphalte Peace-and-Love) A(SIZE= S M L XL) A(COLOR= red blue yellow green)" LA L(MODEL "Modèle: " SIZE "Taille: " COLOR "Couleur: ") mcont \'("#(assoc $(_1) $(LA)) $(_2)") ccont \'("( !( :join-with ",, ") $(@)))) ~( !(:c-continuation ccont :m-continuation mcont) L (MODEL,)=* (SIZE,)=* (COLOR,)=* ) )',
        '#(say)',
